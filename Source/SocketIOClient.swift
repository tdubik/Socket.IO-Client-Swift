...
#include <stdbool.h>
    ...
    /**
     Set to \code
     true
     \endcode if using the node.js version of socket.io. The node.js version of socket.io
    ...
    /**
     ...
     \param items The items to send with this event. May be left out.
    ...
    /**
     ...
     \param items The items to send with this event. Use \code
     []
     \endcode to send nothing.
    ...
    /**
     ...
     \param ack The ack number for this event. May be left out.
    ...
    /**
     ...
     leaveNamespace
     \endcode.
     \param namespace_ The namespace to join.
